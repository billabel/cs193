...
void PrintPolygonInfo() {
	NSLog(@"========================================");
	//PolygonShape *myShape = [[PolygonShape alloc] init];
	PolygonShape *myShape = [[PolygonShape alloc] initWithNumberOfSides:8 minimumNumberOfSides:3 maximumNumberOfSides:12];
	NSLog(@"number of sides: %d", [myShape numberOfSides]);
	NSLog(@"name: %@", [myShape name]);
	NSLog(@"degrees: %f", [myShape angleInDegrees]);
	NSLog(@"radians: %f", [myShape angleInRadians]);
	NSLog(@"description: %@", [myShape description]);
